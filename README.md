...
- [Зміст](#зміст)
- [Інструменти для читання та письма](#інструменти-для-читання-та-письма)
    - [Текстові редактори](#текстові-редактори)
    - [Офісні програми](#офісні-програми)
    - [Інструменти Markdown](#інструменти-markdown)
    - [Нотатки](#нотатки)
    - [Ведення журналу](#ведення-журналу)
    - [Письменництво](#письменництво)
    - [Електронні книги](#електронні-книги)
    - [RSS](#rss)
    - [Інше](#інше)
- [Інструменти розробника](#інструменти-розробника)
    - [IDE (Інтегровані середовища розробки)](#ide)
    - [Утиліти для розробників](#утиліти-для-розробників)
    ...
    - [Термінальні програми](#термінальні-програми)
- [Дизайн та Продукт](#дизайн-та-продукт)
    - [Інструменти дизайну](#інструменти-дизайну)
    - [Прототипування та майндмеппінг](#прототипування-та-майндмеппінг)
    - [Програми для захоплення екрана](#програми-для-захоплення-екрана)
    - [Інші інструменти](#інші-інструменти)
- [AI клієнти](#ai-клієнти)
- [Спілкування](#спілкування)
    - [Інструменти для спільної роботи та команд](#інструменти-для-спільної-роботи-та-команд)
    - [Поштові клієнти](#поштові-клієнти)
    - [Обмін файлами](#обмін-файлами)
- [Інструменти для відновлення даних](#інструменти-для-відновлення-даних)
- [Аудіо та відео інструменти](#аудіо-та-відео-інструменти)
    - [Запис та обробка аудіо](#запис-та-обробка-аудіо)
- [Інструменти керування завантаженнями](#інструменти-керування-завантаженнями)
- [Хмарні сховища](#хмарні-сховища)
- [Методи введення](#методи-введення)
- [Браузери](#браузери)
- [Інструменти перекладу](#інструменти-перекладу)
- [Освіта](#освіта)
- [Фінанси](#фінанси)
- [Шифрування](#шифрування)
- [Інструменти безпеки](#інструменти-безпеки)
- [Проксі та VPN інструменти](#проксі-та-vpn-інструменти)
- [Утиліти](#утиліти)
    - [Інструменти буфера обміну](#інструменти-буфера-обміну)
    - [Інструменти рядка меню](#інструменти-рядка-меню)
    - [Інструменти організації файлів](#інструменти-організації-файлів)
    - [Загальні інструменти](#загальні-інструменти)
    - [Списки справ (To-Do Lists)](#списки-справ-to-do-lists)
    - [Продуктивність](#продуктивність)
    - [Керування вікнами](#керування-вікнами)
    - [Керування паролями](#керування-паролями)
    - [Інструменти Finder](#інструменти-finder)
    - [Покращення якості життя](#покращення-якості-життя)
    - [Системні інструменти](#системні-інструменти)
...
## Інструменти для читання та письма

*Програми для редагування тексту; я рекомендую редактори з відкритим кодом*
...
* [Cursor](https://cursor.com/) - Редактор коду на базі ШІ, створений для надзвичайної продуктивності. Функції включають автозаповнення ШІ, чат та автономного агента кодування. ![Freeware][Freeware Icon]
* [Emacs](https://www.emacswiki.org/emacs/EmacsForMacOS) - Популярний текстовий редактор на базі Unix для програмістів та системних адміністраторів. [![Open-Source Software][OSS Icon]](https://git.savannah.gnu.org/cgit/) ![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/emacs-tw/awesome-emacs#readme)
* [Haystack Editor](https://github.com/haystackeditor/haystack-editor) - Редактор коду з інтерфейсом полотна (canvas) для кращого розуміння коду. [![Open-Source Software][OSS Icon]](https://github.com/haystackeditor/haystack-editor) ![Freeware][Freeware Icon]
* [Helix](https://helix-editor.com/) - Постмодерний модальний текстовий редактор. [![Open-Source Software][OSS Icon]](https://github.com/helix-editor/helix/) ![Freeware][Freeware Icon]
* [Lapce](https://lapce.dev/) - Блискавично швидкий і потужний редактор коду. [![Open-Source Software][OSS Icon]](https://github.com/lapce/lapce) ![Freeware][Freeware Icon]
* [LightTable](http://lighttable.com/) - Редактор коду наступного покоління. [![Open-Source Software][OSS Icon]](https://github.com/LightTable/LightTable) ![Freeware][Freeware Icon]
* [MacVim](https://github.com/macvim-dev/macvim) - Текстовий редактор Vim для macOS. [![Open-Source Software][OSS Icon]](https://github.com/macvim-dev/macvim) ![Freeware][Freeware Icon]
* [micro](https://micro-editor.github.io) - Сучасний та інтуїтивно зрозумілий термінальний текстовий редактор. [![Open-Source Software][OSS Icon]](https://github.com/ory/editor) ![Freeware][Freeware Icon]
* [Neovim](https://github.com/neovim/neovim) - Форк Vim, орієнтований на розширюваність та зручність використання. [![Open-Source Software][OSS Icon]](https://github.com/neovim/neovim) ![Freeware][Freeware Icon]
* [Nova](https://nova.app/) - Красивий, швидкий, гнучкий, нативний редактор коду для Mac від Panic.
* [Plain Text Editor](https://sindresorhus.com/plain-text-editor) - Простий блокнот, що не відволікає. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id1572202501)
* [Sublime Text](http://www.sublimetext.com/3) - Популярний, чистий та елегантний редактор із системою керування плагінами. Для більшої кількості плагінів перегляньте [Плагіни Sublime Text](editor-plugin-zh.md#sublime-text-plugin). [![Awesome List][awesome-list Icon]](https://github.com/dreikanter/sublime-bookmarks#readme)
* [SubEthaEdit](https://subethaedit.net/) - Потужний редактор для письма, кодування та спільної роботи в будь-який час і в будь-якому місці! [![Open-Source Software][OSS Icon]](https://github.com/subethaedit/SubEthaEdit)
* [TextMate](https://macromates.com) - Редактор, який привносить підхід Apple до операційних систем у світ текстових редакторів. [![Open-Source Software][OSS Icon]](https://github.com/textmate/textmate) ![Freeware][Freeware Icon]
* [Tot](https://tot.rocks/) - Tot — це елегантний, простий спосіб збирати та редагувати текст. Це ваш крихітний текстовий компаньйон! ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/us/app/tot/id1491071483)
* [Vim](http://www.vim.org/) - Старий термінальний редактор. Для загальних плагінів перегляньте [Загальні плагіни Vim](editor-plugin-zh.md#vim-plugin). [![Open-Source Software][OSS Icon]](https://github.com/vim/vim) ![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/mhinz/vim-galore#readme)
* [Vimr](http://vimr.org/) - Вдосконалений досвід Vim для OS X. [![Open-Source Software][OSS Icon]](https://github.com/qvacua/vimr/) ![Freeware][Freeware Icon]
* [Windsurf](https://windsurf.com/) - Редактор коду зі штучним інтелектом, що містить Cascade — агентний ШІ, який пише та редагує код автономно. Включає автозаповнення ШІ, пам'ять та підтримку MCP. ![Freeware][Freeware Icon]
* [Zed](https://zed.dev/) - Високопродуктивний багатокористувацький редактор коду від творців Atom та Tree-sitter. [![Open-Source Software][OSS Icon]](https://github.com/zed-industries/zed) ![Freeware][Freeware Icon]

### Офісні програми

* [Keynote](https://apps.apple.com/app/keynote/id409183694?mt=12) - Створюйте приголомшливі презентації. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/keynote/id409183694?mt=12)
* [LibreOffice](https://www.libreoffice.org) - Безкоштовне офісне програмне забезпечення з відкритим кодом, яке щодня використовується та тестується великою спільнотою. [![Open-Source Software][OSS Icon]](https://www.libreoffice.org/about-us/source-code/) ![Freeware][Freeware Icon]
* [Microsoft Office](https://products.office.com/en-us/mac/microsoft-office-for-mac) - Безпомилково Office, розроблений для Mac. [![App Store][app-store Icon]](https://www.apple.com/search/office?page=1&sel=accessories&f=software#!&f=software&fh=4649)
* [Numbers](https://apps.apple.com/app/numbers/id409203825?mt=12) - Створюйте вражаючі електронні таблиці. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/numbers/id409203825?mt=12)
* [OnlyOffice](https://www.onlyoffice.com/) - Офісний пакет, який поєднує редактори тексту, електронних таблиць та презентацій, дозволяючи створювати, переглядати та редагувати локальні документи. [![Open-Source Software][OSS Icon]](https://github.com/ONLYOFFICE/DesktopEditors) ![Freeware][Freeware Icon]
* [Pages](https://apps.apple.com/app/pages/id409201541?mt=12) - Документи, що виділяються. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/pages/id409201541?mt=12)
* [SoftMaker Office](https://www.softmaker.com/en/softmaker-office) - Повний офісний пакет, який прагне повної сумісності з документами Microsoft Office.
* [WPS](https://www.wps.com/mac) - Це кросплатформний офісний пакет програмного забезпечення. ![Freeware][Freeware Icon]

### Інструменти Markdown [![Awesome List][awesome-list Icon]](https://github.com/BubuAnabelas/awesome-markdown#tools)
...
* [Affine](https://affine.pro/) - Affine — це база знань наступного покоління для професіоналів. [![Open-Source Software][OSS Icon]](https://github.com/toeverything/AFFiNE) ![Freeware][Freeware Icon]
...
* [Scribus](https://www.scribus.net/) - Професійне програмне забезпечення для верстки та видавництва. [![OSS][OSS Icon]](https://sourceforge.net/projects/scribus/) ![Freeware][Freeware Icon]
* [Sigil](https://sigil-ebook.com/) - Багатоплатформний редактор електронних книг EPUB. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Sigil-Ebook/Sigil)
* [Simple Comic](https://apps.apple.com/us/app/simple-comic/id1497435571?mt=12) - Читалка електронних книг для форматів PDF, CBZ та CBR з пошуком Live Text. [![Open-Source Software][OSS Icon]](https://github.com/MaddTheSane/Simple-Comic) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/us/app/simple-comic/id1497435571?mt=12)

### RSS

* [Elytra](https://elytra.app) - Простий та конфіденційний RSS-рідер з нативним рендерингом для macOS та iOS. [![App Store][app-store Icon]](https://apps.apple.com/app/apple-store/id1433266971?pt=119194029&ct=awesomemac&mt=8)
* [Feedy](https://krillapps.com/feedy/) - Елегантний та легкий RSS-клієнт і читалка новин для вашого Mac. [![App Store][app-store Icon]](https://itunes.apple.com/us/app/feedy-rss-client/id588288104?ls=1&mt=12)
* [Folo](https://github.com/RSSNext/Folo) 🧡 Інформаційний браузер наступного покоління. [![Open-Source Software][OSS Icon]](https://github.com/RSSNext/Folo) ![Freeware][Freeware Icon]
* [Leaf](http://www.rockysandstudio.com/) - Читалка новин для керування підписками та насолоди щоденними новинами.
* [NetNewsWire](https://ranchero.com/netnewswire/) - Це безкоштовний рідер стрічок новин з відкритим кодом для macOS. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/brentsimmons/NetNewsWire)
* [Doughnut](https://doughnutapp.com/) - Красивий подкаст-кетчер з відкритим кодом для Mac. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/dyerc/Doughnut)
* [ReadKit](http://readkitapp.com/) - Клієнт для керування закладками та RSS.
* [Reeder 5](http://reederapp.com) - Читалка новин для Feedbin, Feedly, Feed Wrangler тощо. [![App Store][app-store Icon]](https://apps.apple.com/pl/app/reeder-5/id1529448980?mt=12)
* [Saga Reader](https://github.com/sopaco/saga-reader) - Блискавично швидкий і надзвичайно легкий інтернет-рідер, керований ШІ. Підтримує отримання інформації з пошукових систем та RSS. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/dyerc/Doughnut)
* [Unread](https://www.goldenhillsoftware.com/unread/) - RSS-рідер з красивою типографікою, що підтримує Feedbin, Feedly тощо. [![App Store][app-store Icon]](https://apps.apple.com/us/app/unread-an-rss-reader/id1363637349)
* [Vienna](http://viennarss.github.io/) - RSS/Atom рідер для Mac OS X. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/ViennaRSS/vienna-rss)

### Інше

* [SwifDoo PDF](https://www.swifdoo.com/) - PDF-редактор/конвертер для редагування, стиснення та захисту паролем PDF-файлів.
* [bindPDF](https://github.com/vishaltelangre/bindPDF) - Об'єднуйте кілька PDF-файлів в один PDF-файл за допомогою зручного інтерфейсу. [![Open-Source Software][OSS Icon]](https://github.com/vishaltelangre/bindPDF) ![Freeware][Freeware Icon]
* [CHM Reader](http://www.hewbo.com/chm-reader.html) - Читайте документи Compiled HTML (.chm) на вашому Mac. ![Freeware][Freeware Icon]
...
* [SkyFonts](https://skyfonts.com/) - Найпростіший спосіб спробувати, встановити та керувати шрифтами.
* [Spillo](https://bananafishsoftware.com/products/spillo/) - Потужний, красивий і дивовижно швидкий клієнт Pinboard для OS X.
* [Tad](https://www.tadviewer.com) - Програма для перегляду та аналізу табличних даних, таких як CSV-файли. [![Open-Source Software][OSS Icon]](https://github.com/antonycourtney/tad) ![Freeware][Freeware Icon]
* [texifier](https://www.texifier.com/) - Чудовий редактор LaTeX для Mac з автоматичним оновленням PDF та автозаповненням команд LaTeX.
* [UPDF](https://updf.com/) - Безкоштовний PDF-редактор для читання, анотування та редагування PDF-файлів. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id1619925971)
* [Zotero](https://www.zotero.org/) - Безкоштовний інструмент для збору, організації, анотування, цитування та обміну дослідженнями. [![OSS][OSS Icon]](https://github.com/zotero/zotero/) ![Freeware][Freeware Icon]
* [Collate](https://collate.one/get-started) - Безкоштовний інструмент для збору, підсумовування та запитів до PDF-файлів за допомогою ШІ. Все офлайн і безкоштовно. [![App Store][app-store Icon]](https://apps.apple.com/us/app/collateai/id6447429913) ![Freeware][Freeware Icon]
* [PDFsail](https://pdfsail.com/) - PDFsail пропонує безкоштовні онлайн-інструменти PDF для редагування, конвертації, об'єднання, стиснення та OCR. Завантаження не потрібне. Спробуйте це рішення "все в одному" з підтримкою ШІ зараз!.
* [TableTool](https://tabletool.io/) - Легкий браузер CSV!
* [Heynote](https://heynote.com/) - Спеціальна чернетка для розробників. ![Freeware][Freeware Icon] ![Open-Source Software][OSS Icon]
...
* [JetBrains Toolbox App](https://www.jetbrains.com/toolbox/) - Керуйте встановленими інструментами JetBrains, завантажуйте нові та відкривайте останні проєкти. ![Freeware][Freeware Icon]
  * [AppCode](https://www.jetbrains.com/objc/) - Розумна IDE для розробки під iOS/macOS.
  * [RustRover](https://www.jetbrains.com/rust/) - Абсолютно нова IDE від JetBrains для розробників Rust.
  * [CLion](https://www.jetbrains.com/clion/) - Потужна IDE для C та C++. (**Безкоштовно** для студентів).
  * [DataGrip](http://www.jetbrains.com/datagrip/) - Кросплатформна IDE для баз даних та SQL. **БЕЗКОШТОВНО** для студентів, перевірте [тут](https://www.jetbrains.com/student/) для отримання додаткової інформації.
  * [DataSpell](https://www.jetbrains.com/dataspell/) - IDE для професійних Data Scientists.
  * [GoLand](https://www.jetbrains.com/go/) - Забезпечує ергономічне середовище для розробки на Go.
  * [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Потужна IDE для мов JVM. (**Безкоштовно** для студентів).
  * [PHPStorm](https://www.jetbrains.com/phpstorm/) - Блискавично розумна PHP IDE.
  * [PyCharm](https://www.jetbrains.com/pycharm/) - Потужна IDE для Python, яка має професійну версію та версію для спільноти (community version).
  * [Rider](https://www.jetbrains.com/rider/) - Кросплатформна IDE для C# з функціями Resharper.
  * [WebStorm](http://www.jetbrains.com/webstorm/) - Найрозумніша JavaScript IDE від JetBrains. **БЕЗКОШТОВНО** для студентів, перевірте [тут](https://www.jetbrains.com/student/) для отримання додаткової інформації.
* [Haskell for Mac](http://haskellformac.com) - Сучасне середовище розробки для Haskell. [![App Store][app-store Icon]](https://itunes.apple.com/app/haskell-development-platform/id841285201)
* [NetBeans IDE](https://netbeans.org/) - Безкоштовна IDE з відкритим кодом для Java та інших мов. [![OSS][OSS Icon]](https://github.com/apache/netbeans) ![Freeware][Freeware Icon]
* [Nova](https://nova.app/) - Красивий, швидкий, гнучкий, нативний редактор коду для Mac від [Panic](https://panic.com/).
* [Trae](https://www.trae.ai/) - IDE від ByteDance з передовими можливостями ШІ, що включає два режими: SOLO для повністю керованої ШІ розробки та IDE для більш традиційного досвіду редагування.
* [Visual Studio Code](https://code.visualstudio.com/) - Безкоштовний редактор з відкритим кодом від Microsoft, дружній до TypeScript, [Плагіни VSCode](editor-plugin.md#vscode-plugin). [![Open-Source Software][OSS Icon]](https://github.com/Microsoft/vscode) ![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/viatsko/awesome-vscode#readme)
* [Windsurf](https://windsurf.com/) - Перша агентна IDE, де розробники та ШІ працюють разом у потоці для магічного досвіду кодування.
* [Xcode](https://developer.apple.com/xcode/) - Необхідна IDE для розробки під iOS/macOS. [![App Store][app-store Icon]](https://itunes.apple.com/app/id497799835)
* [Zed](https://zed.dev/) - Високопродуктивний багатокористувацький редактор коду від творців Atom та Tree-sitter. [![Open-Source Software][OSS Icon]](https://github.com/zed-industries/zed) ![Freeware][Freeware Icon]
* [Spyder](https://www.spyder-ide.org/) - Потужне наукове середовище, написане на Python для Python.
...
* [CodeKit](https://codekitapp.com/) - Інструмент веб-розробки для компіляції та автоматичного оновлення.
* [CodeMenu](https://extiri.com/codemenu.html) - Просунутий менеджер сніпетів з інтеграцією IDE, пошуком природною мовою тощо.
...
* [Finicky](https://johnste.github.io/finicky/) - Встановлюйте правила, щоб вирішувати, який браузер відкриває кожне посилання. [![OSS][OSS Icon]](https://github.com/johnste/finicky) ![Freeware][Freeware Icon]
* [Gas Mask](https://github.com/2ndalpha/gasmask) - Простий менеджер файлів hosts для Mac OS X. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/2ndalpha/gasmask)
* [Gemini](https://macpaw.com/gemini) - Інтелектуальний пошук дублікатів файлів.
* [Hex Fiend](https://ridiculousfish.com/hexfiend/) - Швидкий і розумний hex-редактор з відкритим кодом. [![Open-Source Software][OSS Icon]](https://github.com/ridiculousfish/HexFiend/) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/app/hex-fiend/id1342896380)
* [Hosts.prefpane](https://github.com/specialunderwear/Hosts.prefpane) - Панель системних налаштувань для керування файлом hosts. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/specialunderwear/Hosts.prefpane)
* [Icon Preview](https://sindresorhus.com/icon-preview) - Попередній перегляд іконки програми та іконки в рядку меню. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id6480373509)
* [iHosts](https://en.toolinbox.net/iHosts/) - Єдиний редактор `/etc/hosts` у Mac App Store. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/app/id1102004240?mt=12)
* [ILLA Cloud](https://www.illacloud.com/) - Конструктор внутрішніх інструментів з низьким кодом (low-code). [![Open-Source Software][OSS Icon]](https://github.com/illacloud/illa-builder)
...
* [SCM Breeze](https://github.com/scmbreeze/scm_breeze) - Набір скриптів оболонки (для bash та zsh), які покращують вашу взаємодію з git. ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/scmbreeze/scm_breeze)
* [SecureCRT](https://www.vandyke.com/products/securecrt/) - Емуляція терміналу, яка підтримує SSH, Telnet та інші протоколи.
...
* [ZOC Terminal](https://www.emtec.com/zoc/index.html) - Емулятор терміналу, який підтримує SSH, telnet, з'єднання та інші протоколи.
* [Nib Unlocker](https://apps.apple.com/by/app/nib-unlocker/id1475697086) - Конвертер .nib у .xib. [![App Store][app-store Icon]](https://apps.apple.com/by/app/nib-unlocker/id1475697086?mt=12)
* [He3](https://he3.app) - Безкоштовний і сучасний набір утиліт для розробників. ![Freeware][Freeware Icon]

### Редактори регулярних виразів

* [Patterns](http://krillapps.com/patterns/) - Редактор регулярних виразів.
* [Regex](https://motionobj.com/regex/) - Інструмент тестування регулярних виразів з акцентом на простоту.
* [RegExRX](http://www.mactechnologies.com/index.php?page=downloads#regexrx) - Інструмент розробки для регулярних виразів.
* [RegexMate](https://apps.apple.com/app/6479819388) - Інструмент тестування регулярних виразів із вбудованим коротким довідником.
...
* [Charles](https://www.charlesproxy.com/) - HTTP проксі/монітор для перегляду HTTP та HTTPS трафіку.
* [James](https://github.com/james-proxy/james) - Проксі-інструмент з відкритим кодом для перевірки та маппінгу запитів як http, так і https. [![Open-Source Software][OSS Icon]](https://github.com/james-proxy/james) ![Freeware][Freeware Icon]
* [Little Snitch](https://www.obdev.at/products/littlesnitch/download.html) - Мережевий монітор з картою світу для візуалізації мережевих з'єднань.
* [mitmproxy](https://mitmproxy.org/) - Інтерактивний перехоплювальний HTTP-проксі для тестувальників на проникнення та розробників програмного забезпечення. [![Open-Source Software][OSS Icon]](https://github.com/mitmproxy/mitmproxy) ![Freeware][Freeware Icon]
* [Proxie](https://proxie.app) - Проксі для налагодження HTTP.
* [Proxyman](https://proxyman.app) - Сучасний та інтуїтивно зрозумілий проксі для налагодження HTTP для macOS. ![Freeware][Freeware Icon]
* [Sniffnet](https://github.com/GyulyVGC/sniffnet) - Програма для комфортного моніторингу вашого мережевого трафіку. [![Open-Source Software][OSS Icon]](https://github.com/GyulyVGC/sniffnet) ![Freeware][Freeware Icon]
...
* [Cornerstone](http://www.zennaware.com/cornerstone/) - Потужний контроль версій із чудовим інтерфейсом.
* [Fork](https://git-fork.com/) - Швидкий та дружній Git клієнт для Mac.
* [Git Cola](https://git-cola.github.io/) - Потужний, швидкий, легкий та дружній графічний інтерфейс Git. Для тих, хто залежить від кофеїну. ![Open-Source Software][OSS Icon]
* [Gitbar](https://github.com/Shikkic/gitbar) - ПЗ з відкритим кодом, відображає статистику внесків GitHub у вашому рядку меню. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Shikkic/gitbar)
* [GitButler](https://gitbutler.com/) - Керування змінами з паралельними та стековими гілками, необмеженим скасуванням (undo) та інтеграцією агентів. [![Open-Source Software][OSS Icon]](https://github.com/gitbutlerapp/gitbutler) ![Freeware][Freeware Icon]
* [GitFinder](https://gitfinder.com/) - Швидкий і легкий Git клієнт для Mac з інтеграцією Finder.
* [Gitfox](https://www.gitfox.app) - Робіть коміти швидше, покращуйте якість коду за допомогою чудових diff - і виглядайте при цьому добре. [![App Store][app-store Icon]](https://apps.apple.com/app/gitfox/id1475511261)
* [GitHub Desktop](https://desktop.github.com/) - Офіційний графічний інтерфейс GitHub. [![Freeware][Freeware Icon] ![Open-Source Software][OSS Icon]](https://github.com/desktop/desktop)
* [GitKraken](https://www.gitkraken.com/) - Найпопулярніший графічний інтерфейс Git для Windows, Mac та Linux.
* [GitUp](http://gitup.co/) - Простий і потужний Git клієнт. [![Open-Source Software][OSS Icon]](https://github.com/git-up/GitUp) ![Freeware][Freeware Icon]
* [GitX-dev](https://rowanj.github.io/gitx/) - Форк чудового [Pieter's](https://github.com/pieter/gitx) графічного інтерфейсу Git для OS X. Включає бічну панель гілок/тегів та різні виправлення. [![Open-Source Software][OSS Icon]](https://github.com/rowanj/gitx) ![Freeware][Freeware Icon]
* [Hub](https://hub.github.com/) - Обгортка командного рядка для Git, яка робить вас кращими на GitHub. [![Open-Source Software][OSS Icon]](https://github.com/github/hub) ![Freeware][Freeware Icon]
* [RelaGit](https://rela.dev/) - Елегантне рішення для графічного контролю версій. Створено розробниками для розробників. [![Open-Source Software][OSS Icon]](https://github.com/relagit/relagit) ![Freeware][Freeware Icon]
* [SmartGit](http://www.syntevo.com/smartgit/) - Git клієнт з підтримкою.
* [SourceTree](https://www.sourcetreeapp.com/) - Безкоштовний клієнт Git та Mercurial для Windows або Mac. ![Freeware][Freeware Icon]
* [Sublime Merge](https://www.sublimemerge.com/) - Git клієнт від творців Sublime Text.
* [Tempo](https://github.com/maoyama/Tempo) - Графічний Git клієнт. Замініть Git CLI на зрозумілий інтерфейс та допомогу ШІ. [![Freeware][Freeware Icon] ![Open-Source Software][OSS Icon]](https://github.com/maoyama/Tempo)
* [Tower2](https://www.git-tower.com/) - Найпотужніший Git клієнт для Mac та Windows.
* [Vershd](https://vershd.io/) - Безкоштовний для особистого використання зручний графічний інтерфейс Git для Windows, Mac та Linux. ![Freeware][Freeware Icon]
* [Versions](https://www.versionsapp.com/) - Клієнт Subversion (SVN) для Mac.

### Віртуалізація

* [Docker](https://www.docker.com/) - Потужна віртуалізація на рівні операційної системи. [![Open-Source Software][OSS Icon]](https://github.com/docker) ![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/veggiemonk/awesome-docker#readme)
* [MacVirtue](https://naden.co) - Запускайте безкоштовні та необмежені віртуальні машини на вашому Mac.
* [Multipass](https://multipass.run/) - ВМ Ubuntu на вимогу для будь-якої робочої станції. [![Open-Source Software][OSS Icon]](https://github.com/canonical/multipass)
* [OrbStack](https://orbstack.dev/) - Швидкий, легкий і простий спосіб запуску контейнерів Docker і Linux машин на macOS. ![Freeware][Freeware Icon]
* [Parallels](http://www.parallels.com/) - Потужна, проста у використанні ВМ. Немає безкоштовного оновлення для кожної нової Mac OS.
* [Podman Desktop](https://podman-desktop.io/) - Графічний інструмент з відкритим кодом для керування контейнерами та Kubernetes. [![Open-Source Software][OSS Icon]](https://github.com/containers/podman-desktop) ![Freeware][Freeware Icon]
* [Rancher Desktop](https://rancherdesktop.io) - Керування контейнерами та Kubernetes на робочому столі. [![OSS][OSS Icon]](https://github.com/rancher-sandbox/rancher-desktop/blob/main/LICENSE)
* [Lima](https://github.com/lima-vm/lima) - Lima запускає віртуальні машини Linux з автоматичним обміном файлами та переадресацією портів. [![Open-Source Software][OSS Icon]](https://github.com/lima-vm/lima)
* [QEMU](https://www.qemu.org/) - Безкоштовний емулятор і віртуалізатор з відкритим кодом, який може виконувати апаратну віртуалізацію. [![Open-Source Software][OSS Icon]](https://github.com/qemu/qemu) ![Freeware][Freeware Icon]
* [UTM](https://mac.getutm.app/) - UTM — це простий у використанні графічний інтерфейс для QEMU, який може запускати ARM64, x64 та інші ВМ на Mac з M1. [![Open-Source Software][OSS Icon]](https://github.com/utmapp/UTM)
* [Vagrant](https://www.vagrantup.com) - Інструмент для створення та розповсюдження середовищ розробки. [![Open-Source Software][OSS Icon]](https://github.com/mitchellh/vagrant) ![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/iJackUA/awesome-vagrant#readme)
* [Veertu](https://veertu.com) - Найлегша ВМ на Mac. Адаптивний, ізольований і нативний спосіб запуску ВМ на вашому Mac. ![Freeware][Freeware Icon]
* [Virtual Box](http://www.virtualbox.org) - Потужний продукт віртуалізації x86 та AMD64/Intel64. ![Freeware][Freeware Icon]
* [VMware Fusion](http://www.vmware.com/) - Потужна комерційна ВМ, розроблена VMware.
...
* [Keylord](https://protonail.com) - Десктопний GUI клієнт для баз даних "ключ-значення" Redis, Bolt, LevelDB та Memcached.
* [MDB Explorer](http://www.macexplorer.co/en/mdb-explorer.php) - Інструмент MDB для відкриття, читання, експорту ваших файлів MDB в інші формати та бази даних.
* [Medis](http://getmedis.com) - GUI менеджер для Redis. [![Open-Source Software][OSS Icon]](https://github.com/luin/medis)
* [Mingo](https://mingo.io/) - Простий у використанні графічний інтерфейс MongoDB з приголомшливими функціями.
* [mongoDB.app](https://gcollazo.github.io/mongodbapp/) - Найпростіший спосіб почати роботу з mongoDB на Mac. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/gcollazo/mongodbapp)
* [MongoDB](https://www.mongodb.com) - Масштабована, гнучка документна база даних із запитами та індексацією. [![OSS][OSS Icon]](https://github.com/gcollazo/mongodbapp) ![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/ramnes/awesome-mongodb#desktop)
* [MySQL Workbench](http://dev.mysql.com/downloads/workbench/) - Офіційний графічний інтерфейс MySQL.
* [Navicat Data Modeler](https://www.navicat.com/en/products/navicat-data-modeler) - Економічно вигідний інструмент проєктування баз даних для високоякісних моделей даних.
* [neo4j](https://neo4j.com) - Провідна графова база даних! [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/neo4j/neo4j)
* [pgMagic🪄](https://pgmagic.app/?ref=awesomemac) - Спілкуйтеся з Postgres природною мовою або SQL.
* [pgModeler](https://pgmodeler.io) - pgModeler — це інструмент моделювання даних з відкритим кодом, розроблений для PostgreSQL. [![Open-Source Software][OSS Icon]](https://github.com/pgmodeler/pgmodeler) ![Freeware][Freeware Icon]
* [Postgres.app](http://postgresapp.com/) - Найпростіший спосіб почати роботу з PostgreSQL на Mac. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/PostgresApp/PostgresApp)
* [Postico](https://eggerapps.at/postico/) - Сучасний клієнт PostgreSQL для Mac.
* [PSequel](http://www.psequel.com/) - Інструмент GUI PostgreSQL для Mac OS X. ![Freeware][Freeware Icon]
* [RedisClient](https://github.com/UUGU/redis-client-app) - Клієнтська програма Redis для mac, windows та linux. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/UUGU/redis-client-app)
* [RedisDesktopManager](http://redisdesktop.com) - Кросплатформний інструмент керування GUI для Redis. [![Open-Source Software][OSS Icon]](https://github.com/uglide/RedisDesktopManager) ![Freeware][Freeware Icon]
* [Sequel Pro](http://www.sequelpro.com/) - Керування базою даних MySQL для Mac OS X. [![Open-Source Software][OSS Icon]](https://github.com/sequelpro/sequelpro) ![Freeware][Freeware Icon]
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) - Підтримуваний "сиквел" давнього інструменту macOS Sequel Pro. [![Open-Source Software][oss icon]](https://github.com/Sequel-Ace/Sequel-Ace)
* [SQLight](https://aurvan.com/sqlight/) - Інструмент керування базою даних SQLite. ![Freeware][Freeware Icon]
* [SQLPro Studio](http://www.sqlprostudio.com/) - Простий, потужний менеджер баз даних для macOS.
* [Studio 3T](https://studio3t.com/) - Найкращий графічний інтерфейс для MongoDB. ![Freeware][Freeware Icon]
* [SurrealDB](https://github.com/surrealdb/surrealdb) - Масштабована, розподілена, спільна документно-графова база даних для веб у реальному часі. [![Open-Source Software][oss icon]](https://github.com/surrealdb/surrealdb)
* [Tableau Public](https://public.tableau.com/s/) - Безкоштовне програмне забезпечення для візуалізації даних. ![Freeware][Freeware Icon]
* [TablePlus](https://tableplus.io) - Підтримує: PostgreSQL, MySQL, RedShift, MariaDB... Гарантована безпека високого рівня.
* [TrailBase](https://trailbase.io) - Відкрита альтернатива FireBase з субмілісекундною затримкою, одним виконуваним файлом, типобезпечними API, сповіщеннями, вбудованим середовищем виконання JS/TS, автентифікацією та адмін-панеллю, побудована на SQLite, Rust та V8. [![Open-Source Software][OSS Icon]](https://github.com/trailbaseio/trailbase)
* [redis-pro](https://github.com/cmushroom/redis-pro) - Невеликий, простий у використанні менеджер Redis, написаний за допомогою SwiftUI, підтримує темний режим. [![Open-Source Software][OSS Icon]](https://github.com/cmushroom/redis-pro) ![Freeware][Freeware Icon]

### Термінальні програми

* [alacritty](https://github.com/jwilm/alacritty) - Кросплатформний емулятор терміналу з прискоренням GPU. [![Open-Source Software][OSS Icon]](https://github.com/jwilm/alacritty) ![Freeware][Freeware Icon]
* [electerm](https://electerm.github.io/electerm/) - Безкоштовний багатоплатформний термінал та інструмент SSH/SFTP з красивим інтерфейсом, який є ідеальною альтернативою XShell для Windows! [![Open-Source Software][OSS Icon]](https://github.com/electerm/electerm) ![Freeware][Freeware Icon]
* [Ghostty](https://github.com/ghostty-org/ghostty) - Швидкий, багатофункціональний і кросплатформний емулятор терміналу, який використовує нативний інтерфейс платформи та прискорення GPU. [![Open-Source Software][OSS Icon]](https://github.com/ghostty-org/ghostty) ![Freeware][Freeware Icon]
* [hyper](https://hyper.is) - Термінал, побудований на веб-технологіях. [![Open-Source Software][OSS Icon]](https://github.com/zeit/hyper) ![Freeware][Freeware Icon]
* [iTerm2](http://www.iterm2.com) - iTerm2 — це дивовижний емулятор терміналу для OS X. [![Open-Source Software][OSS Icon]](https://github.com/gnachman/iTerm2) ![Freeware][Freeware Icon]
* [kitty](https://github.com/kovidgoyal/kitty) - Кросплатформний, швидкий, повнофункціональний емулятор терміналу на базі GPU. [![Open-Source Software][OSS Icon]](https://github.com/kovidgoyal/kitty) ![Freeware][Freeware Icon]
...
* [inklet](https://tenonedesign.com/inklet.php) - Перетворіть трекпад вашого Mac на дошку для малювання.
* [Inkscape](https://inkscape.org/en/) - Професійний редактор векторної графіки. [![Open-Source Software][OSS Icon]](https://launchpad.net/inkscape)
* [Krita](https://krita.org/en/) - Програмне забезпечення для цифрового живопису з відкритим кодом для концепт-художників, ілюстраторів та художників коміксів. [![Open-Source Software][OSS Icon]](https://github.com/KDE/krita) ![Freeware][Freeware Icon]
* [macSVG](https://macsvg.org/) - Проєктування HTML5 SVG арту та анімації. [![Open-Source Software][OSS Icon]](https://github.com/dsward2/macSVG) ![Freeware][Freeware Icon]
* [MagicaVoxel](https://ephtracy.github.io/) - Безкоштовний, легкий 8-бітний воксельний редактор та інтерактивний рендерер трасування шляху.
* [MakeHuman](http://www.makehumancommunity.org) - Потужний і безкоштовний 3D моделлер людей. ![Freeware][Freeware Icon]
* [Monodraw](http://monodraw.helftone.com) - Потужний редактор ASCII art, розроблений для Mac. [![App Store][app-store Icon]](https://itunes.apple.com/app/monodraw/id920404675)
* [Nik Collection](https://nikcollection.dxo.com/) - Nik Collection від DxO.
* [Paintbrush](http://paintbrush.sourceforge.net/) - Редактор растрових зображень. [![Open-Source Software][OSS Icon]](https://sourceforge.net/projects/paintbrush/files/) ![Freeware][Freeware Icon]
...
* [Sketch](http://www.sketchapp.com/) - Професійний цифровий дизайн для mac.
    * [Sketch Cache Cleaner](https://yo-op.github.io/sketchcachecleaner/) - Видаляє приховані файли історії Sketch. [![OSS][OSS Icon]](https://github.com/yo-op/sketchcachecleaner) ![Freeware][Freeware Icon]
    * [Measure Plugin](http://utom.design/measure/) - Зробіть створення специфікацій для розробників та колег веселим. [![Open-Source Software][OSS Icon]](https://github.com/utom/sketch-measure) ![Freeware][Freeware Icon]
    * [Sketch Toolbox Plugin Manager](http://sketchtoolbox.com/) - Простий менеджер плагінів для Sketch. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/buzzfeed/Sketch-Toolbox)
...
* [Nugget](https://github.com/cartesiancs/nugget-app) - Програмне забезпечення для редагування відео, розроблене для ефектів руху та універсальності. [![OSS][OSS Icon]](https://github.com/yo-op/sketchcachecleaner) ![Freeware][Freeware Icon]
* [Lunacy](https://icons8.com/lunacy) - Інструмент векторного графічного дизайну для UI/UX з підтримкою офлайн, вбудованими активами та спільною роботою в реальному часі. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/us/app/lunacy-graphic-design-editor/id1582493835?mt=12)
...
* [MockFlow](https://www.mockflow.com) - Онлайн пакет прототипування для вебдизайну та тестування юзабіліті.
* [Mockplus](http://www.mockplus.com) - Прототипуйте швидше, розумніше та простіше.
* [OmniGraffle](https://www.omnigroup.com/omnigraffle) - Створення діаграм та графічний дизайн для Mac, iPhone та iPad.
* [Origami Studio](http://origami.design/) - Інструмент для проєктування сучасних інтерфейсів, створений і використовуваний дизайнерами Facebook.
* [pencil](http://pencil.evolus.vn/) - Безкоштовний інструмент з відкритим кодом для створення діаграм та прототипування графічного інтерфейсу. [![Open-Source Software][OSS Icon]](https://github.com/evolus/pencil) ![Freeware][Freeware Icon]
* [ProtoPie](https://www.protopie.io/) - Створюйте найсучасніші прототипи так само легко, як пиріг.
* [QuikFlow](https://quikflow.app) - Створюйте блок-схеми з робочим процесом майндмеппінгу.
* [Scapple](http://www.literatureandlatte.com/scapple.php) - Практичне програмне забезпечення для майндмеппінгу з вільним макетом, як на дошці.
...
* [CleanShot X](https://cleanshot.com/) - Відкрийте для себе кращий спосіб захоплення екрана вашого Mac.
* [CloudApp](https://www.getcloudapp.com/) - Працюйте зі швидкістю погляду. ![Freeware][Freeware Icon]
* [Flameshot](https://github.com/flameshot-org/flameshot) - Потужне, але просте у використанні програмне забезпечення для скріншотів. ![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]
* [Gifox](https://gifox.app) - Запис та обмін GIF.
* [Kap](https://getkap.co/) - Записувач екрана з відкритим кодом, побудований за допомогою веб-технологій. [![Open-Source Software][OSS Icon]](https://github.com/wulkano/kap) ![Freeware][Freeware Icon]
* [KeyCastr](https://github.com/keycastr/keycastr) - KeyCastr, візуалізатор натискань клавіш з відкритим кодом. [![Open-Source Software][OSS Icon]](https://github.com/keycastr/keycastr) ![Freeware][Freeware Icon]
* [Kyapchar](https://github.com/vishaltelangre/Kyapchar) - Простий записувач аудіо екрана та мікрофона для Mac. [![Open-Source Software][OSS Icon]](https://github.com/vishaltelangre/Kyapchar) ![Freeware][Freeware Icon]
* [Licecap](http://www.cockos.com/licecap/) - Записуйте свій екран та експортуйте у GIF. Ви можете змінити область запису будь-коли під час запису. [![Open-Source Software][OSS Icon]](https://github.com/justinfrankel/licecap) ![Freeware][Freeware Icon]
...
* [iPic](https://en.toolinbox.net/iPic/) - Легко завантажуйте зображення з підтримкою Markdown. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/app/id1101244278?ls=1&mt=12&at=1000lv4R&ct=iPic_me)
* [JPEGmini](http://www.jpegmini.com/) - Зменшуйте розмір зображення до 80% без втрати якості.
* [Mark Man](http://getmarkman.com/) - Вимірюйте та створюйте специфікації швидко.
* [Nucleo](https://nucleoapp.com/) - Менеджер іконок. Імпорт, експорт, налаштування та конвертація бібліотек іконок.
* [Preset Brewery](https://www.presetbrewery.com) - Інструмент для конвертації пресетів Lightroom в Adobe Camera Raw.
* [qView](https://interversehq.com/qview/) - qView — це переглядач зображень, розроблений з урахуванням мінімалізму та зручності використання. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/jurplel/qView)
* [Resize Master](http://www.boltnev.com/resizemaster/) - Пакетна зміна розміру та додавання водяних знаків до ваших зображень швидко та легко. [![App Store][app-store Icon]](https://itunes.apple.com/app/resize-master/id1025306797)
* [RightFont](http://rightfontapp.com/) - Переглядайте, синхронізуйте, встановлюйте та керуйте шрифтами на Mac, Dropbox або Google Drive.
* [Snagit](https://www.techsmith.com/snagit.html) - Просте, потужне програмне забезпечення для захоплення та запису екрана.
* [svgus](http://www.svgs.us/) - Організуйте, очищайте та трансформуйте свої SVG. [![App Store][app-store Icon]](https://itunes.apple.com/app/svgsus/id1106867065)
* [TinyPNG4Mac](https://github.com/kyleduo/TinyPNG4Mac) - Інструмент з відкритим кодом для стиснення зображень. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/kyleduo/TinyPNG4Mac)
...
* [remio](https://www.remio.ai/?utm_source=github_list) - Персональний ChatGPT, який відповідає на основі ваших знань. Підтримка новітніх LLM, пріоритет локальної роботи та BYOK (свій ключ). [![Freeware][Freeware Icon]](https://www.remio.ai/?utm_source=github_list)


## Спілкування

### Інструменти для спільної роботи та команд
...
* [ThunderBird](https://www.mozilla.org/en-US/thunderbird/) - Програмне забезпечення, яке спрощує роботу з електронною поштою. ![Freeware][Freeware Icon]
* [Tutanota](https://tutanota.com/) - Зашифрована електронна пошта, орієнтована на безпеку та конфіденційність. [![Open-Source Software][OSS Icon]](https://github.com/tutao/tutanota) ![Freeware][Freeware Icon]
* [Edison Mail](https://mail.edison.tech/mac) - Простий та красивий поштовий клієнт з можливістю налаштування. ![Freeware][Freeware Icon]
* [Skiff Mail](https://skiff.com/mail) - Зашифрована та децентралізована електронна пошта - доступна в Інтернеті, iOS/Android та macOS. ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/skiff-org/skiff-mail)
...
* [Data Rescue](https://www.prosofteng.com/mac-data-recovery) - Комплексний та професійний інструмент відновлення даних для більшості випадків.
* [DiskWarrior](http://www.alsoft.com/DiskWarrior/) - Найдосконаліший у світі інструмент ремонту та відновлення для Mac.
* [R-Studio for Mac](http://www.r-studio.com/data_recovery_macintosh/) - Потужний інструмент для відновлення даних на дисках, навіть якщо їх розділи відформатовані, пошкоджені або видалені.
* [SuperDuper!](https://shirt-pocket.com/SuperDuper/SuperDuperDescription.html) - Безболісне повне резервне копіювання завантажувальних дисків.
* [Disk Drill](https://www.cleverfiles.com/) - Безкоштовний інструмент відновлення даних. Також має версію PRO. [![App Store][app-store Icon]](https://apps.apple.com/us/app/disk-drill-media-recovery/id431224317?mt=12)

## Аудіо та відео інструменти
...
* [Audacity](http://www.audacityteam.org/) - Безкоштовне кросплатформне аудіо програмне забезпечення з відкритим кодом для багатоканального запису та редагування. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/audacity/audacity)
* [Audio Hijack](http://www.rogueamoeba.com/audiohijack/) - Записуйте аудіо з будь-якої програми, включаючи дзвінки VoIP зі Skype, веб-потоки з Safari та багато іншого.
* [BeMyEars](https://www.bemyears.cn/) - Безкоштовно для людей з вадами слуху, системні живі субтитри на пристрої, підтримка багатьох мов, ніби у вас є субтитри YouTube скрізь.
...
* [Hydrogen](http://hydrogen-music.org/) - Професійне, але просте та інтуїтивно зрозуміле програмування ударних на основі патернів для GNU/Linux. [![Open-Source Software][OSS Icon]](https://github.com/hydrogen-music/hydrogen)
* [ffWorks](https://www.ffworks.net/) - Комплексний медіа-інструмент для macOS. Робить високоякісне кодування відео доступним для всіх.
* [IINA](https://iina.io/) - Сучасний відеоплеєр для macOS. Заснований на mpv, потужному проєкті медіаплеєра. [![Open-Source Software][OSS Icon]](https://github.com/iina/iina) ![Freeware][Freeware Icon]
* [Jellyfin](https://github.com/jellyfin/jellyfin) - Медіасистема з безкоштовним програмним забезпеченням. [![Open-Source Software][OSS Icon]](https://jellyfin.org) ![Freeware][Freeware Icon]
* [Kodi](https://kodi.tv/) - Відзначений нагородами безкоштовний медіацентр з відкритим кодом (GPL) для відтворення відео, музики, зображень, ігор тощо. [![Open-Source Software][OSS Icon]](https://github.com/xbmc/xbmc) ![Freeware][Freeware Icon]
* [LMMS](https://lmms.io) - Раніше "Linux MultiMedia Studio", LMMS — це потужна цифрова аудіо робоча станція, розроблена подібно до FL Studio (раніше Fruity Loops). [![Open-Source Software][OSS Icon]](https://github.com/lmms/lmms) ![Freeware][Freeware Icon]
* [LosslessCut](https://github.com/mifi/lossless-cut) - Кросплатформний інструмент для швидкої та безвтратної обрізки відео та аудіо за допомогою ffmpeg. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/mifi/lossless-cut)
* [LyricGlow](https://github.com/ateymoori/lyricglow) - Синхронізований плеєр текстів пісень з ефектами світіння слово за словом для Spotify, Apple Music та YouTube Music. [![Open-Source Software][OSS Icon]](https://github.com/ateymoori/lyricglow) ![Freeware][Freeware Icon]
...
* [Movie Catcher](https://evilcult.github.io/moviecatcher/) - Програма для перегляду фільмів та онлайн-перегляду з офлайн-завантаженням, з Baidu cloud для офлайн-завантаження та онлайн-відтворення. [![Open-Source Software][OSS Icon]](https://github.com/EvilCult/moviecatcher)
* [mpv](https://www.mpv.io/) - Безкоштовний медіаплеєр з відкритим кодом та кросплатформною підтримкою. [![Open-Source Software][OSS Icon]](https://github.com/mpv-player/mpv) ![Freeware][Freeware Icon]
* [MuseScore](https://musescore.org/) - Безкоштовне програмне забезпечення для нотного запису з відкритим кодом. [![Open-Source Software][OSS Icon]](https://github.com/musescore/MuseScore) ![Freeware][Freeware Icon]
* [Museeks](https://museeks.io) - Простий, чистий та кросплатформний музичний плеєр. [![Open-Source Software][OSS Icon]](https://github.com/martpie/museeks) ![Freeware][Freeware Icon]
* [Natron](https://natrongithub.github.io/) - Програмне забезпечення для композитингу з відкритим кодом. На основі вузлів (node-graph). Схожий за функціональністю на Adobe After Effects та Nuke від The Foundry. [![Open-Source Software][OSS Icon]](https://github.com/MrKepzie/Natron)
* [Nuclear](https://nuclear.js.org/) - Потоковий музичний плеєр, який знаходить безкоштовну музику для вас. [![Open-Source Software][OSS Icon]](https://github.com/nukeop/nuclear) ![Freeware][Freeware Icon]
* [Perian](http://perian.org/#download) - (**Більше не розробляється активно**) ~~Дозволяє QuickTime відтворювати всі поширені формати безкоштовних плагінів~~. [![Open-Source Software][OSS Icon]](https://github.com/MaddTheSane/perian)
* [MusicBrainz Picard](https://picard.musicbrainz.org/) - Кросплатформний тегер музики, написаний на Python. [![Open-Source Software][OSS Icon]](https://github.com/metabrainz/picard) ![Freeware][Freeware Icon]
* [MyMedia](https://github.com/photangralenphie/MyMedia) - Відображайте та дивіться свою локальну бібліотеку фільмів та телешоу. [![Open-Source Software][OSS Icon]](https://github.com/photangralenphie/MyMedia) ![Freeware][Freeware Icon]
* [Playback](https://mafintosh.github.io/playback/) - Експериментальний відеоплеєр. ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/mafintosh/playback)
* [Plug](https://plugformac.com) - Відкривайте та слухайте музику з Hype Machine. [![Open-Source Software][OSS Icon]](https://github.com/wulkano/Plug) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id1514182074)
* [Popcorn Time](https://popcorn-time.site/) - Дивіться торрент-фільми миттєво, сервіс Popcorn Time ніколи не буде закритий. Завантажуйте та насолоджуйтесь. [![Open-Source Software][OSS Icon]](https://github.com/popcorn-official/popcorn-desktop) ![Freeware][Freeware Icon]
* [Potplayer X](https://okaapps.com/product/1612400976)- Відео та аудіо плеєр. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/cn/app/potplayer-x-%E9%9F%B3%E8%A7%86%E9%A2%91%E6%92%AD%E6%94%BE%E5%99%A8/id1612400976?mt=12)
* [Pulp](https://github.com/bazalp/pulp/releases) - Менеджер аудіо семплів. ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/bazalp/pulp)
* [ScreenFlow](http://www.telestream.net/screenflow/) - Програмне забезпечення для скрінкастингу та редагування відео.
* [Shotcut](https://www.shotcut.org) - Безкоштовний відеоредактор з відкритим кодом. [![Open-Source Software][OSS Icon]](https://github.com/mltframework/shotcut) ![Freeware][Freeware Icon]
* [Sonora](https://github.com/sonoramac/Sonora) - Мінімалістичний, красиво оформлений музичний плеєр. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/sonoramac/Sonora)
* [SpotMenu](https://github.com/kmikiy/SpotMenu) - Spotify та iTunes у вашому рядку меню. [![Open-Source Software][OSS Icon]](https://github.com/kmikiy/SpotMenu) ![Freeware][Freeware Icon]
* [Stremio](https://www.stremio.com/) - Фільми, телешоу, серіали, пряме телебачення або веб-канали, такі як YouTube і Twitch.tv - ви можете знайти все це на Stremio. ![Freeware][Freeware Icon]
* [Stringed 2](http://stringed.buenosapps.com/) - Програмне забезпечення для музичної практики, розроблене, щоб допомогти користувачам навчитися грати свої улюблені пісні.
* [Synfig Studio](http://synfig.org) - Synfig Studio — це безкоштовне програмне забезпечення для 2D анімації з відкритим кодом. [![Open-Source Software][OSS Icon]](https://github.com/synfig/synfig) ![Freeware][Freeware Icon]
* [trax](https://github.com/nbonamy/trax) - Безкоштовний інструмент керування музичною бібліотекою з відкритим кодом із функціями конвертації аудіо та керування тегами. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/nbonamy/trax)
* [Tiny Player](https://www.catnapgames.com/tiny-player-for-mac/) - Як випливає з назви, крихітний плеєр. ![Freeware][Freeware Icon]
* [Tuneful](https://www.tuneful.dev) - Керуйте Spotify та Apple Music з "чубчика" (notch), рядка меню або міні-плеєра. Легко та нативно. [![App Store][app-store Icon]](https://apps.apple.com/app/tuneful/id6739804295)
* [VLC](http://www.videolan.org/index.html) - Безкоштовний кросплатформний мультимедійний плеєр та фреймворк з відкритим кодом, який відтворює більшість мультимедійних файлів, DVD, Audio CD, VCD та різні потокові протоколи. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/videolan/vlc)
* [VOX Player](https://vox.rocks/mac-music-player) - Аудіоплеєр високої чіткості для Mac та iPhone. Музика просто звучить краще! ![Freeware][Freeware Icon]
* [VidCrop](https://apps.apple.com/app/VidCrop/6752624705) - Простий інструмент для обрізки відео, що підтримує кілька форматів та точну обрізку.
...
### Запис та обробка аудіо

* [CapSoftware](https://github.com/CapSoftware/) - Альтернатива Loom з відкритим кодом. Красивий інструмент для запису екрана з можливістю поділитися. [![Open-Source Software][OSS Icon]](https://github.com/CapSoftware/) ![Freeware][Freeware Icon]
* [GarageBand](https://www.apple.com/mac/garageband/) - Безкоштовна цифрова аудіо робоча станція (DAW) від Apple, що надає простий інтерфейс та професійні функції створення аудіо. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/cn/app/garageband/id682658836?l=zh&ls=1&mt=12)
* [Logic Pro X](https://www.apple.com/logic-pro/) - Професійна цифрова аудіо робоча станція (DAW) від Apple, що надає повні функції створення аудіо разом з високоякісними нативними плагінами та саундтреками. З нативною підтримкою Apple Silicon. [![App Store][app-store Icon]](https://apps.apple.com/cn/app/logic-pro-x/id634148309?l=zh&mt=12)
* [Stargate DAW](https://github.com/stargatedaw/stargate) - Цифрова аудіо робоча станція (DAW) та пакет плагінів "все-в-одному". [![Open-Source Software][OSS Icon]](https://github.com/aria2) ![Freeware][Freeware Icon]
* [Quick Recorder](https://lihaoyun6.github.io/quickrecorder/) - Легкий та високопродуктивний записувач екрана для macOS [![Open-Source Software][OSS Icon]](https://github.com/lihaoyun6/QuickRecorder) ![Freeware][Freeware Icon]

## Інструменти керування завантаженнями

* [aria2](https://aria2.github.io/) - Легка багатопротокольна та багатоджерельна утиліта завантаження командного рядка. [![Open-Source Software][OSS Icon]](https://github.com/aria2) ![Freeware][Freeware Icon]
* [Downie](https://software.charliemonroe.net/downie.php) - Завантажувач відео для macOS з підтримкою YouTube та інших 1200 сайтів.
* [Deluge](https://deluge-torrent.org/) - Deluge — це легкий, безкоштовний, кросплатформний BitTorrent клієнт. [![Open-Source Software][OSS Icon]](https://dev.deluge-torrent.org/wiki/Development) ![Freeware][Freeware Icon]
* [FOLX](http://mac.eltima.com/download-manager.html) - Безкоштовний менеджер завантажень для Mac OS X зі справжнім інтерфейсом у стилі Mac. ![Freeware][Freeware Icon]
* [Free Download Manager](https://www.freedownloadmanager.org/) - Потужний, простий у використанні та повністю безкоштовний прискорювач і менеджер завантажень. ![Freeware][Freeware Icon]
* [JDownloader](http://jdownloader.org/) - Безкоштовний інструмент керування завантаженнями з відкритим кодом з величезною спільнотою розробників, що робить завантаження таким легким і швидким, яким воно і має бути. ![Freeware][Freeware Icon] ![Open-Source Software][OSS Icon]
* [Motrix](https://motrix.app/) - Motrix — це повнофункціональний менеджер завантажень, який підтримує завантаження HTTP, FTP, BitTorrent, Magnet, Baidu Net Disk тощо. [![Open-Source Software][OSS Icon]](https://github.com/agalwood/Motrix) ![Freeware][Freeware Icon]
* [Neat Download Manager](https://www.neatdownloadmanager.com/) - Neat Download Manager — це простий та легкий графічний інтерфейс навколо потужного та оптимізованого рушія завантажень. ![Freeware][Freeware Icon]
* [qBittorrent](https://www.qbittorrent.org/) - Проєкт, спрямований на надання альтернативи µTorrent з відкритим кодом. [![Open-Source Software][OSS Icon]](https://github.com/qbittorrent/qBittorrent) ![Freeware][Freeware Icon]
* [Shuttle](https://fiplab.com/apps/download-shuttle-for-mac) - Легкий менеджер завантажень для будь-яких посилань.
* [Swads](https://swads.app/) - Клієнт Synology Download Station, сучасний, нативний та інтуїтивно перероблений.
* [Transmission](https://www.transmissionbt.com/) - Швидкий, легкий, безкоштовний BitTorrent клієнт. [![Open-Source Software][OSS Icon]](https://github.com/transmission/transmission) ![Freeware][Freeware Icon]
* [You-Get](https://you-get.org/) - Крихітна утиліта командного рядка для завантаження медіа-контенту (відео, аудіо, зображень) з Інтернету. [![Open-Source Software][OSS Icon]](https://github.com/soimort/you-get) ![Freeware][Freeware Icon]
* [youtube-dl](https://github.com/rg3/youtube-dl/) - Програма командного рядка для завантаження відео з YouTube.com та інших відеосайтів [![Open-Source Software][OSS Icon]](https://github.com/rg3/youtube-dl/) ![Freeware][Freeware Icon]

## Хмарні сховища

*Я рекомендую використовувати онлайн-сховища з клієнтами для Mac*

* [Arq](https://www.arqbackup.com/) - Клієнт резервного копіювання хмарного сховища, що підтримує AWS, GCP, DropBox та інші.
* [Carbonite](https://www.carbonite.com/learn/how-to-backup-mac/) - Carbonite може захистити ваш Mac від усіх найпоширеніших форм втрати даних.
* [Dropbox](https://www.dropbox.com/) - Сервіс хостингу файлів, що пропонує хмарне сховище та синхронізацію файлів з функціями спільного редагування. ![Freeware][Freeware Icon]
* [Mega](https://mega.nz) - Безкоштовний хмарний сервіс, пропонує 50 ГБ вільного місця. ![Freeware][Freeware Icon]
* [NextCloud](https://nextcloud.com/) - Активно підтримуваний форк ownCloud, швидший і повністю відкритий [![Open-Source Software][OSS Icon]](https://github.com/nextcloud)
* [ownCloud](https://owncloud.org) - Хмарне сховище.
* [Seafile](https://www.seafile.com/) - Надійна та високошвидкісна синхронізація файлів та обмін ними.![Freeware][Freeware Icon]

## Методи введення

* [Kawa](https://github.com/utatti/kawa) - Кращий перемикач джерел введення для OS X. [![Open-Source Software][OSS Icon]](https://github.com/utatti/kawa) ![Freeware][Freeware Icon]
* [Rocket](http://matthewpalmer.net/rocket/) - Робить введення емодзі швидшим і простішим за допомогою ярликів у стилі Slack. ![Freeware][Freeware Icon]
* [Touch Emoji](https://github.com/lessmess-dev/touch-emoji) - Вибір емодзі для MacBook Pro Touch Bar. [![Open-Source Software][OSS Icon]](https://github.com/lessmess-dev/touch-emoji)
* [Type2Phone](https://www.houdah.com/type2Phone/) - Використовуйте свій Mac як клавіатуру для iPhone, iPad та Apple TV.
* [betterglobekey](https://github.com/Serpentiel/betterglobekey) - Зробіть клавішу Globe на macOS знову великою! [![Open-Source Software][OSS Icon]](https://github.com/Serpentiel/betterglobekey) ![Freeware][Freeware Icon]
* [InputSourcePro](https://inputsource.pro/) - Інструмент для багатомовних користувачів, який автоматично перемикає джерело введення між програмами та вебсайтами. [![Open-Source Software][OSS Icon]](https://github.com/runjuu/InputSourcePro) ![Freeware][Freeware Icon]

## Браузери

* [Arc](https://arc.net/) - Arc — це ваш простір, щоб дихати в Інтернеті. Браузер, обладнаний для того, як ми використовуємо Інтернет у 2024 році, і фундаментальний для того, як ми сподіваємося використовувати його в майбутньому. ![Freeware][Freeware Icon]
* [Brave](https://brave.com/) - Веб-браузер з акцентом на конфіденційність та швидкість. [![Open-Source Software][OSS Icon]](https://github.com/brave/brave-browser/) ![Freeware][Freeware Icon]
* [ChatGPT Atlas](https://chatgpt.com/atlas/) - ChatGPT Atlas, браузер із вбудованим ChatGPT. Отримуйте миттєві відповіді, резюме та розумну веб-допомогу прямо з будь-якої сторінки. ![Freeware][Freeware Icon]
* [Chrome](https://www.google.com/chrome/) - Chrome, розроблений Google ![Freeware][Freeware Icon]
* [Chromium](https://www.chromium.org/Home) - Безкоштовний проєкт веб-браузера з відкритим кодом від Google, що надає вихідний код для Google Chrome. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://chromium.googlesource.com/chromium/src/)
  * [ungoogled-chromium](https://github.com/ungoogled-software/ungoogled-chromium) - Легкий підхід до видалення залежності від веб-сервісів Google. [![Open-Source Software][OSS Icon]](https://github.com/ungoogled-software/ungoogled-chromium) ![Freeware][Freeware Icon]
* [Firefox](https://www.firefox.com/) - Безкоштовний веб-браузер з відкритим кодом, розроблений Mozilla. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://hg.mozilla.org/)
  * [LibreWolf](https://librewolf.net) - Форк Firefox, орієнтований на конфіденційність, безпеку та свободу. [![Open-Source Software][OSS Icon]](https://gitlab.com/librewolf-community) ![Freeware][Freeware Icon]
* [Microsoft Edge](https://www.microsoft.com/edge) - Microsoft Edge, заснований на Chromium, але створений MS ![Freeware][Freeware Icon]
* [Min](https://minbrowser.org/) - Швидкий, мінімалістичний браузер, який захищає вашу конфіденційність. [![Open-Source Software][OSS Icon]](https://github.com/minbrowser/min) ![Freeware][Freeware Icon]
* [Opera](https://www.opera.com) - Відчуйте швидший перегляд без відволікань з блокуванням реклами та приватним переглядом. ![Freeware][Freeware Icon]
* [Ora](https://www.orabrowser.com/) - Браузер для macOS з відкритим кодом, створений за допомогою Swift та WebKit. Швидка, безпечна та нативна альтернатива Arc з плавним керуванням вкладками, просторами та вертикальною бічною панеллю. [![Open-Source Software][OSS Icon]](https://github.com/the-ora/browser) ![Freeware][Freeware Icon]
...
* [Vivaldi](https://vivaldi.com) - Браузер, який дає вам контроль. ![Freeware][Freeware Icon]
* [Yandex](https://browser.yandex.com/) - Швидкий і безпечний браузер від Yandex для комп'ютерів. ![Freeware][Freeware Icon]
* [Zen](https://zen-browser.app/) - Красиво оформлений, орієнтований на конфіденційність та багатофункціональний браузер ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/zen-browser/desktop)

## Інструменти перекладу

*(Або ви можете просто використовувати вбудований словник Mac OS)*

* [DeepL](https://www.deepl.com/en/app/) - Найкраща якість перекладів ![Freeware][Freeware Icon]
* [Easydict](https://github.com/tisfeng/Easydict) - Легко шукати слова або перекладати текст [![Open-Source Software][OSS Icon]](https://github.com/tisfeng/Easydict)
* [Grammarly](https://app.grammarly.com/) - Вдосконалюйте свою англійську
...
* [Wokabulary](https://wokabulary.com/) - Збирайте, практикуйте та організовуйте свій індивідуальний словниковий запас іноземної мови. [![App Store][app-store Icon]](https://apps.apple.com/app/apple-store/id1667619825)

## Фінанси

* [SubManager](https://submanager.app) - Відстежуйте свої підписки в одному місці та отримуйте сповіщення, коли підписку потрібно подовжити. Доступно для macOS, iOS та visionOS і синхронізується між усіма вашими пристроями. [![App Store][app-store Icon]](https://apps.apple.com/app/submanager-subscription-list/id1632853914)

## Шифрування

* [Cryptomator](https://cryptomator.org/) - Багатоплатформне прозоре шифрування ваших файлів у хмарі на стороні клієнта. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/cryptomator/cryptomator/)
* [Deadbolt](https://github.com/alichtman/deadbolt) - Найпростіший інструмент шифрування файлів, який ви коли-небудь використовували. Сумісний з macOS і має відкритий код, тому ви можете йому довіряти. [![Open-Source Software][OSS Icon]](https://github.com/alichtman/deadbolt) ![Freeware][Freeware Icon]

## Інструменти безпеки

* [Antivirus One](https://cleanerone.trendmicro.com/antivirus-one-for-mac/?utm_source=github&utm_medium=referral&utm_campaign=githubproject) - Надійний захист безпеки Mac: захистіть свій Mac від вірусів, шкідливого та рекламного ПЗ. Блокуйте потенційні веб-загрози та захищайте свій Mac від вразливостей.![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/apple-store/id1068435535?pt=444218&ct=GitHub&mt=8)
* [BlockBlock](https://objective-see.com/products/blockblock.html) - Я: "Будь ласка, сповіщайте мене щоразу, коли щось постійно встановлюється." BlockBlock: "Зрозумів" [![Open-Source Software][OSS Icon]](https://github.com/objective-see/BlockBlock)
* [Dylib Hijack Scanner](https://objective-see.com/products/dhs.html) - Проста утиліта, яка сканує ваш комп'ютер на наявність програм, які або вразливі до перехоплення dylib, або були перехоплені. [![Open-Source Software][OSS Icon]](https://github.com/objective-see/DylibHijackScanner)
* [KextViewer](https://objective-see.com/products/kextviewr.html) - Переглядайте всі модулі, які завантажені в ядро ОС. [![Open-Source Software][OSS Icon]](https://github.com/objective-see/KextViewr)
* [KnockKnock](https://objective-see.com/products/knockknock.html) - Подивіться, що постійно встановлено на вашому Mac. [![Open-Source Software][OSS Icon]](https://github.com/objective-see/KnockKnock)
* [LinkLiar](http://halo.github.io/LinkLiar) - Графічний інтерфейс для підміни MAC-адреси (Link-Layer) для macOS. [![Open-Source Software][OSS Icon]](https://github.com/halo/LinkLiar) ![Freeware][Freeware Icon]
...
## Проксі та VPN інструменти

* [Algo](https://github.com/trailofbits/algo) - Персональний IPSEC VPN у хмарі. [![Open-Source Software][OSS Icon]](https://github.com/trailofbits/algo)
...
* [Boop](https://boop.okat.best/) - Інструмент для сніпетів, що надає різні функції, такі як форматування JSON, контрольна сума MD5, реверс рядка, кодування та багато іншого. [![Open-Source Software][OSS Icon]](https://github.com/IvanMathy/Boop)
* [CleanClip](https://cleanclip.cc) - Найчистіший менеджер буфера обміну на macOS! ![Freeware][Freeware Icon]
...
* [Paste](http://pasteapp.me) - Розумна історія буфера обміну та менеджер сніпетів. [![App Store][app-store Icon]](https://apps.apple.com/us/app/paste-clipboard-history-manager/id967805235)
* [PasteBar](https://github.com/PasteBar/PasteBarApp) - Безлімітний, безкоштовний менеджер буфера обміну для Mac та Windows. [![Open-Source Software][OSS Icon]](https://github.com/PasteBar/PasteBarApp) ![Freeware][Freeware Icon]
* [PasteBot](https://tapbots.com/pastebot/) - Потужний менеджер буфера обміну. [![App Store][app-store Icon]](https://itunes.apple.com/us/app/pastebot/id1179623856)
* [Pure Paste](https://sindresorhus.com/pure-paste) - Вставка як звичайний текст за замовчуванням. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id1611378436)
* [Flycut](https://github.com/TermiT/Flycut) - Чистий і простий менеджер буфера обміну для розробників. [![Open-Source Software][OSS Icon]](https://github.com/TermiT/Flycut) ![Freeware][Freeware Icon]
* [Maccy](https://maccy.app/) - Легкий менеджер буфера обміну для macOS. [![Open-Source Software][OSS Icon]](https://github.com/p0deje/Maccy) ![Freeware][Freeware Icon]
* [uPaste](https://okaapps.com/product/1503649026) - Розумна історія буфера обміну та менеджер сніпетів, автоматично записує та організовує вашу історію копіювання/вставки. Тож ви можете використовувати вміст буфера обміну будь-коли та будь-де з елегантним красивим інтерфейсом. [![App Store][app-store Icon]](macappstore://itunes.apple.com/app/id1503649026?pt=119209922&l=en&mt=12&ct=github)
* [Yippy](https://github.com/mattDavo/Yippy) - Менеджер буфера обміну зі зручним інтерфейсом. [![Open-Source Software][OSS Icon]](https://github.com/mattDavo/Yippy) ![Freeware][Freeware Icon]
...
* [Eye Timer](https://adelmaer.com/eyetimer) - Таймер перерв для запобігання напруженню очей для Mac. [![App Store][app-store Icon]](https://apps.apple.com/us/app/eye-timer/id1485856873)
* [Fishing Funds](https://ff.1zilc.top) - Відображення трендів китайських фондів у реальному часі в рядку меню. [![Open-Source Software][OSS Icon]](https://github.com/1zilc/fishing-funds) ![Freeware][Freeware Icon]
* [Folder Peek](https://sindresorhus.com/folder-peek) - Швидкий доступ до документів, файлів, папок та програм з рядка меню. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id1615988943)
* [Hidden](https://github.com/dwarvesf/hidden) - Ультралегка утиліта MacOS, яка допомагає приховати іконки рядка меню. [![Open-Source Software][OSS Icon]](https://github.com/dwarvesf/hidden) ![Freeware][Freeware Icon]
* [Hue in the Menu](https://apps.apple.com/gb/app/hue-in-the-menu/id1534707384) - Керування освітленням Philips Hue в рядку меню з підтримкою кількох кімнат. [![App Store][app-store Icon]](https://apps.apple.com/gb/app/hue-in-the-menu/id1534707384) ![Freeware][Freeware Icon]
* [Ice](https://github.com/jordanbaird/Ice) - Безкоштовна альтернатива Bartender з відкритим кодом. Допомагає приховати пункти меню та надає варіанти для різних макетів. ![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]
...
* [BetterZip](https://macitbetter.com/) - Інструмент архівації підтримує ZIP, TAR, TGZ, TBZ, TXZ (новий), 7-ZIP, RAR.
* [eZip](http://ezip.awehunt.com) - Простий у використанні, багатофункціональний архіватор для macOS. Підтримує популярні формати, такі як RAR, ZIP, 7Z, BZ2, GZ тощо. Чудово працює з темним режимом Mojave та QuickLook. ![Freeware][Freeware Icon]
* [Fileside](https://www.fileside.app) - Сучасний файловий менеджер з плитковим інтерфейсом та необмеженою кількістю панелей.
* [Folders File Manager](https://foldersapp.dev) - Файловий менеджер з розширюваним деревом папок, схожим на провідник Windows.
* [Hazel](https://www.noodlesoft.com) - Автоматизована організація файлів для вашого Mac. Відповідально та красиво розроблений.
* [Keka](https://www.keka.io) - Файловий архіватор для macOS. Стиснення: 7Z, ZIP, TAR, GZIP, BZIP2, XZ LZIP, DMG, ISO. Вилучення: 7Z, ZIP, RAR, TAR, GZIP, BZIP2, XZ, LZIP, DMG, ISO, LZMA, EXE, CAB, WIM, PAX, JAR, APK, APPX, CPGZ, CPIO. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/app/keka/id470158793)
* [muCommander](http://www.mucommander.com) - Легкий файловий менеджер з двопанельним інтерфейсом. [![Open-Source Software][OSS Icon]](https://github.com/mucommander/mucommander) ![Freeware][Freeware Icon]
* [Modal File Manager](https://github.com/raguay/ModalFileManager/) - Легкий, мінімалістичний двопанельний файловий менеджер з гарячими клавішами в стилі Vim. Його можна налаштувати за допомогою тем і розширень, завантажених з GitHub через вбудований інтерфейс. [![Open-Source Software][OSS Icon]](https://GitHub.com/raguay/ModalFileManager) ![Freeware][Freeware Icon]
* [Oka Unarchiver](https://okaapps.com/product/1441507725) - Підтримка формату RAR, пакетне розпакування архівів, архіви, захищені паролем, вилучення та архівування в один клік. [![App Store][app-store Icon]](macappstore://itunes.apple.com/app/id1441507725?pt=119209922&l=en&mt=12&ct=github)
* [PDF Archiver](https://github.com/JulianKahnert/PDF-Archiver) - Хороший інструмент для завдань тегування та архівування. [![Open-Source Software][OSS Icon]](https://github.com/JulianKahnert/PDF-Archiver) [![App Store][app-store Icon]](https://itunes.apple.com/app/pdf-archivar/id1352719750)
* [Rapidmg](https://rapidmg.branchseer.com/) Вилучення програм з образів DMG до папки "Applications" в один клік. [![App Store][app-store Icon]](https://apps.apple.com/app/rapidmg/id6451349778)
* [The Unarchiver](https://theunarchiver.com/) - Розархівовуйте багато різних видів архівних файлів. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/us/app/the-unarchiver/id425424353)
* [Unarchive One](https://cleanerone.trendmicro.com/unarchiver-one/?utm_source=github&utm_medium=referral&utm_campaign=githubproject) - Швидко розпаковуйте різні типи стислих файлів у різні формати. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/apple-store/id1127253508?pt=444218&ct=GitHub&mt=8)
* [Marta](https://marta.sh) - Файловий менеджер для macOS, написаний повністю на Swift ![Freeware][Freeware Icon]
...
* [Vidwall](https://apps.apple.com/app/Vidwall/6747587746) - Легко імпортуйте відео MP4/MOV як системні шпалери та анімацію екрана блокування. [![Open-Source Software][OSS Icon]](https://github.com/jaywcjlove/vidwall) ![Freeware][Freeware Icon]
* [CapsLockNoDelay](https://github.com/gkpln3/CapsLockNoDelay) - Видаляє затримку активації клавіші Caps Lock для швидкого набору тексту. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/gkpln3/CapsLockNoDelay)
...
* [Day Progress](https://sindresorhus.com/day-progress) - Час, що залишився сьогодні, у вашому рядку меню. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id6450280202)
...
* [nnScreenshots](https://www.nearnorthsoftware.com/software/screenshots.php) - Суперлегкий спосіб вести візуальний запис вашої продуктивності, щоб полегшити заповнення табелів робочого часу або просто допомогти вам переглянути день. Вбудований редактор табелів.
* [OmniPlan](https://www.omnigroup.com/omniplan/) - Найкращий спосіб візуалізувати, підтримувати та спрощувати ваші проєкти. Управління проєктами стало легким.
* [OpenIn](https://loshadki.app/openin4/) - Візьміть під контроль встановлені програми на вашому Mac [![App Store][app-store Icon]](https://apps.apple.com/us/app/openin-4-advanced-link-handler/id1643649331?mt=12)
* [PaletteBrain](https://palettebrain.com) - Отримайте доступ до потужності ChatGPT у всіх ваших програмах Mac натисканням комбінації клавіш.
* [Pie Menu](https://www.pie-menu.com) – Керуйте своїми інструментами за допомогою радіального меню, налаштованого для вашої активної програми.
* [Perplexity](https://apps.apple.com/us/app/perplexity-ask-anything/id6714467650) - Пошук та відкриття за допомогою ШІ.
* [Pomodoro Cycle](https://github.com/jet8a/pomodoro-cycle-app) - Трекер Pomodoro
* [Qbserve](https://qotoqot.com/qbserve/) - Автоматизація відстеження часу: відстеження фріланс-проєктів, табелі робочого часу, виставлення рахунків та зворотний зв'язок щодо продуктивності в реальному часі.
* [Raycast](https://raycast.com?via=ae02) - Raycast дозволяє керувати інструментами та програмами за допомогою скорочень, завантажувати розширення з магазину та використовувати моделі ШІ, такі як ChatGPT, DeepSeek, Gemini, Claude тощо. Ви також можете створювати сніпети та використовувати нотатки Raycast для максимізації своєї продуктивності.
* [RescueTime](https://www.rescuetime.com/) - Сервіс персональної аналітики, який показує, як ви витрачаєте свій час, і надає інструменти, які допоможуть вам бути більш продуктивними.
* [SuperCorners](https://supercorners.vercel.app/) - Зробіть кути екрана більш потужними — перетворити Активні кути на ефективні тригери робочого процесу. [![Open-Source Software][OSS Icon]](https://github.com/daniyalmaster693/SuperCorners) ![Freeware][Freeware Icon]
* [Rize](https://rize.io/) - Тайм-трекер на основі ШІ, який автоматично покращує вашу концентрацію та допомагає формувати кращі робочі звички.
* [RightMenu Master](https://wangchujiang.com/rightmenu-master/) - Чудовий інструмент для покращення контекстного меню Finder, щоб зробити ваше меню правої кнопки миші потужнішим. [![App Store][app-store Icon]](https://apps.apple.com/app/rightmenu-master/6737160756)
...
* [AeroSpace](https://github.com/nikitabobko/AeroSpace) - Тайловий віконний менеджер у стилі i3 для macOS. [![Open-Source Software][OSS Icon]](https://github.com/nikitabobko/AeroSpace) ![Freeware][Freeware Icon]
* [AltTab](https://alt-tab-macos.netlify.app) - Перемикач вікон з відкритим кодом та попереднім переглядом вікон. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/lwouis/alt-tab-macos)
* [Amethyst](http://ianyh.com/amethyst/) - Тайловий віконний менеджер. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/ianyh/Amethyst)
...
* [IntelliDock](https://mightymac.app/intellidock/) - Приховує Dock, автоматично.
* [JankyBorders](https://github.com/FelixKratz/JankyBorders) - Легка система рамок вікон для macOS. [![Open-Source Software][OSS Icon]](https://github.com/FelixKratz/JankyBorders) ![Freeware][Freeware Icon]
* [Loop](https://github.com/MrKai77/Loop) - Керування вікнами зроблено елегантно. [Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/MrKai77/Loop)
* [MacsyZones](https://macsyzones.com/) - Організуйте свої вікна з легкістю та підвищте свою продуктивність. [![Open-Source Software][OSS Icon]](https://github.com/rohanrhu/MacsyZones) ![Freeware][Freeware Icon]
* [Lasso](https://thelasso.app) - Інтуїтивно зрозумілий та простий у використанні віконний менеджер на основі сітки.
* [Magnet](http://magnet.crowdcafe.com/) - Віконний менеджер, що тримає ваш робочий простір організованим. [![App Store][app-store Icon]](https://itunes.apple.com/us/app/id441258766)
...
* [Total Spaces](http://totalspaces.binaryage.com/) - Забезпечує керування вікнами, дуже схоже на ubuntu. Створює гарячі клавіші для робочих просторів, що дозволяє легко переміщатися.
* [yabai](https://github.com/koekeishiya/yabai) - Тайловий віконний менеджер для macOS. Переписаний chunkwm, забезпечує більш безшовну інтеграцію з операційною системою. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/koekeishiya/yabai/wiki)

### Керування паролями

* [1Password](https://1password.com/) - Кросплатформний інструмент керування паролями.
* [Bitwarden](https://bitwarden.com) - Інструмент керування паролями з відкритим кодом для Mac OS, iOS та браузерів. [![Open-Source Software][OSS Icon]](https://github.com/bitwarden) ![Freeware][Freeware Icon]
* [Buttercup](https://buttercup.pw/) - Менеджер паролів, на який ви заслуговуєте ![Freeware][Freeware Icon]
* [Dashlane](https://www.dashlane.com) - Хмарний менеджер паролів з дизайном, відзначеним нагородами.
* [Enpass](https://www.enpass.io/) - Кросплатформний інструмент керування паролями з хмарною інтеграцією. [![App Store][app-store Icon]](https://itunes.apple.com/us/app/enpass-password-manager/id455566716)
* [Keyzer](https://apps.apple.com/app/Keyzer/6500434773) - Простий менеджер паролів, який підтримує збереження портативних файлів паролів.
...
* [Command X](https://sindresorhus.com/command-x) - Вирізати та вставити файли у Finder. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id1666327168)
* [Default Folder X](https://www.stclairsoft.com/DefaultFolderX/index.html) - Швидкий доступ до ваших файлів і папок у кожній програмі.
* [FileMinutes](https://www.fileminutes.com/) - Знаходьте файли та виконуйте дії, все в одному.
* [FinderFix](https://synappser.github.io/apps/finderfix/) - Нарешті, тривале рішення для розміру та положення вікон Finder. ![Freeware][Freeware Icon].
...
* [XtraFinder](https://www.trankynam.com/xtrafinder/) - Додає вкладки та функцію вирізання до Mac Finder. ![Freeware][Freeware Icon]

### Покращення якості життя

* [Actions](https://github.com/sindresorhus/Actions) - Надає багато корисних дій для програми "Швидкі команди" (Shortcuts). [![Open-Source Software][OSS Icon]](https://github.com/sindresorhus/Actions) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id1586435171)
...
* [AlDente](https://apphousekitchen.com/) - Обмежувач заряду батареї для MacBook. [![Open-Source Software][OSS Icon]](https://github.com/davidwernhart/AlDente)
* [Amphetamine](https://itunes.apple.com/us/app/amphetamine/id937984704) - Тримайте ваш Mac у стані бадьорості. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/us/app/amphetamine/id937984704)
* [AdBlock One](https://cleanerone.trendmicro.com/ad-block-one-for-mac/?utm_source=github&utm_medium=referral&utm_campaign=githubproject) - Безкоштовний блокувальник реклами для Safari.![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/apple-store/id1491889901?pt=444218&ct=GitHub&mt=8)
* [AppCleaner](http://freemacsoft.net/appcleaner/) - Ретельно видаляйте програми. ![Freeware][Freeware Icon]
* [Apple Silicon App Test](https://doesitarm.com/apple-silicon-app-test/) - Перевірте сумісність програм з Apple Silicon. [![Open-Source Software][OSS Icon]](https://github.com/ThatGuySam/doesitarm) ![Freeware][Freeware Icon]
* [AirBattery](https://lihaoyun6.github.io/airbattery/) - Переглядайте батареї всіх пристроїв у Dock, рядку меню або віджетах. [![Open-Source Software][OSS Icon]](https://github.com/lihaoyun6/AirBattery) ![Freeware][Freeware Icon]
* [Background Music](https://github.com/kyleneideck/BackgroundMusic) - Керуйте гучністю програм та записуйте системне аудіо. [![Open-Source Software][OSS Icon]](https://github.com/kyleneideck/BackgroundMusic)
* [Cleaner One](https://apps.apple.com/app/apple-store/id1133028347?pt=444218&ct=GitHub&mt=8) - Очищення диска та оптимізація Mac. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/apple-store/id1133028347?pt=444218&ct=GitHub&mt=8)
* [Cleaner for Xcode](https://github.com/waylybaye/XcodeCleaner-SwiftUI) - Видаліть непотрібні файли Xcode. [![Open-Source Software][OSS Icon]](https://github.com/waylybaye/XcodeCleaner-SwiftUI) ![Freeware][Freeware Icon]
* [coconutBattery](https://www.coconut-flavour.com/coconutbattery/) - Інформація про батарею Mac та статистика.
* [DaisyDisk](https://daisydiskapp.com/) - Аналізатор використання диска та очищувач.
* [Dayflow](https://github.com/JerryZLiu/Dayflow) - Часова шкала активності екрана з підтримкою ШІ. [![Open-Source Software][OSS Icon]](https://github.com/JerryZLiu/Dayflow) ![Freeware][Freeware Icon]
* [DockAnchor](https://github.com/bwya77/DockAnchor) - Заблокуйте Dock macOS на одному екрані в налаштуванні з кількома моніторами. [![Open-Source Software][OSS Icon]](https://github.com/bwya77/DockAnchor) ![Freeware][Freeware Icon]
* [everythingByMdfind](https://github.com/appledragon/everythingByMdfind) - Швидкий пошук файлів за допомогою Spotlight. [![Open-Source Software][OSS Icon]](https://github.com/appledragon/everythingByMdfind) ![Freeware][Freeware Icon]
* [gfxCardStatus](https://gfx.io/) - Моніторинг використання відеокарти та вплив на батарею. ![Freeware][Freeware Icon]
* [GrandPerspective](https://grandperspectiv.sourceforge.net) - Візуалізуйте використання диска за допомогою деревоподібних карт. [![Open-Source Software][OSS Icon]](https://git.code.sf.net/p/grandperspectiv/source) [![Freeware][Freeware Icon]](https://sourceforge.net/projects/grandperspectiv/files/grandperspective/) [![App Store][app-store Icon]](https://itunes.apple.com/us/app/grandperspective/id1111570163)
* [Gray](https://github.com/zenangst/Gray) - Перемикач світлого/темного режиму для окремих програм. ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/zenangst/Gray)
* [HandShaker](http://www.smartisan.com/apps/handshaker) - Керуйте вмістом телефону Android на Mac. ![Freeware][Freeware Icon]
* [iStat Menus](https://bjango.com/mac/istatmenus/) - Просунутий системний монітор для рядка меню.
* [iStats](https://github.com/Chris911/iStats) - Інструмент системної інформації командного рядка. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Chris911/iStats)
* [Juice](https://github.com/brianmichel/Juice) - Розширене відображення інформації про батарею. [![Open-Source Software][OSS Icon]](https://github.com/brianmichel/Juice) ![Freeware][Freeware Icon]
* [KeepingYouAwake](https://github.com/newmarcel/KeepingYouAwake) - Альтернатива Caffeine з підтримкою темного режиму. [![Open-Source Software][OSS Icon]](https://github.com/newmarcel/KeepingYouAwake)
* [MagicQuit](https://magicquit.com/) - Автоматично закриває невикористовувані програми на macOS для звільнення пам'яті, наведення ладу на робочому столі та покращення часу автономної роботи. [![Open-Source Software][OSS Icon]](https://github.com/BigBerny/magicquit) ![Freeware][Freeware Icon]
* [Monity](http://www.monityapp.com/) - Віджет моніторингу системи для OS X.
* [Mounty](http://enjoygineering.com/mounty/) - Крихітний інструмент для перемонтування захищених від запису NTFS томів під Mac OS X 10.9+ в режим читання-запису. ![Freeware][Freeware Icon]
* [NitroShare](https://nitroshare.net/) - Кросплатформна передача файлів по мережі. [![Open-Source Software][OSS Icon]](https://github.com/nitroshare/nitroshare-desktop) ![Freeware][Freeware Icon]
* [OmniDiskSweeper](https://www.omnigroup.com/more) - Показує файли на вашому диску, впорядковані за розміром. Його можна використовувати для пошуку та видалення невикористовуваних файлів. ![Freeware][Freeware Icon]
* [OnyX](https://www.titanium-software.fr/en/onyx.html) - Багатофункціональна утиліта для перевірки дисків і файлів, виконання завдань з очищення та обслуговування системи, налаштування прихованих параметрів та багато іншого. ![Freeware][Freeware Icon]
* [Pearcleaner](https://itsalin.com/appInfo/?id=pearcleaner) - Безкоштовний, source-available та fair-code ліцензований очищувач програм Mac. ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/alienator88/Pearcleaner)
* [Paragon NTFS](https://www.paragon-software.com/home/ntfs-mac/) - Доступ на читання/запис до NTFS у macOS Sierra.
* [stats](https://github.com/exelban/stats) - безкоштовний системний монітор Mac для рядка меню. [![Open-Source Software][OSS Icon]](https://github.com/exelban/stats)
* [Sensei](https://sensei.app/) - Sensei — це мультиінструмент для продуктивності Mac з функціями, що охоплюють як апаратне, так і програмне забезпечення.
* [Sleepr](https://sleepr.app/) - Sleepr повертає таймер сну на macOS. [![App Store][app-store Icon]](https://apps.apple.com/us/app/sleepr-app/id6465683427)
* [Sloth](https://sveinbjorn.org/sloth/) - Показує всі відкриті файли, каталоги, сокети, канали та пристрої, що використовуються всіма запущеними процесами. [![Open-Source Software][OSS Icon]](https://github.com/sveinbjornt/Sloth/) ![Freeware][Freeware Icon]
* [SteerMouse](https://plentycom.jp/en/steermouse/) - SteerMouse — це утиліта, яка дозволяє вільно налаштовувати кнопки, коліщатка та швидкість курсора. Підтримуються як USB, так і Bluetooth миші.
* [SwiftQuit](https://github.com/onebadidea/swiftquit/) - Вмикає автоматичний вихід з програм macOS при закритті їх вікон. [![Open-Source Software][OSS Icon]](https://github.com/onebadidea/swiftquit) ![Freeware][Freeware Icon]
* [Core Tunnel](https://codinn.com/tunnel/) - Програма для керування з'єднаннями SSH. [![App Store][app-store Icon]](https://apps.apple.com/us/app/core-tunnel/id1354318707)
* [TG Pro](https://www.tunabellysoftware.com/tgpro/) - Моніторинг температури, керування вентиляторами та діагностика обладнання, щоб допомогти зберегти ваш Mac прохолодним і здоровим.
* [Time Machine Inspector](https://github.com/probablykasper/time-machine-inspector) - Дізнайтеся, що займає місце у ваших резервних копіях Time Machine. [![Open-Source Software][OSS Icon]](https://github.com/probablykasper/time-machine-inspector) ![Freeware][Freeware Icon]
* [Tuxera NTFS](http://www.tuxera.com/products/tuxera-ntfs-for-mac/) - Повна сумісність читання-запису з NTFS-відформатованими дисками на Mac.
* [Overkill](https://github.com/KrauseFx/overkill-for-mac) - Зупиніть відкриття iTunes, коли ви підключаєте свій iPhone.
...
* [Ryubing](https://github.com/Ryubing) - Форк припиненого емулятора Switch, Ryujinx. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Ryubing)
* [Suyu](https://suyu.dev/) - Знайомий, потужний емулятор Nintendo Switch з відкритим кодом. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://git.suyu.dev/suyu/suyu)
* [Whisky](https://getwhisky.app/) - Обгортка Wine, що підтримує GPTK (Game Porting Toolkit) [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Whisky-App/Whisky)

## Програми для віддаленого входу

* [AnyDesk](https://anydesk.com) - Забезпечує віддалений доступ між кількома машинами.
* [Moonlight](https://github.com/moonlight-stream/moonlight-qt) - Клієнт GameStream для ПК (Windows, Mac, Linux та Steam Link). [![Open-Source Software][OSS Icon]](https://github.com/moonlight-stream/moonlight-qt) ![Freeware][Freeware Icon]
* [Parsec](https://parsec.app) - Parsec пропонує безшовний досвід 4k зі швидкістю до 60 кадрів в секунду з майже нульовою затримкою. Безпечний, гнучкий, легкий доступ до всього, що ви робите, у будь-який час, з будь-якого місця.
...
* [QLMarkdown](https://github.com/sbarex/QLMarkdown) - Розширення Quick Look для файлів Markdown. - ![Freeware][Freeware Icon] ![Open-Source Software][OSS Icon]
...
* [Open Alternative](https://openalternative.co/) - Відкрийте для себе альтернативи популярного програмного забезпечення з відкритим кодом. Ретельно підібрана колекція найкращих альтернатив з відкритим кодом для повсякденних SaaS-продуктів. Заощаджуйте гроші за допомогою надійних інструментів, підібраних для вас.
* MacUpdate：[https://www.macupdate.com/](https://www.macupdate.com/)
* Інші сайти, такі як [MacStories](https://www.macstories.net/), [LifeHacker](http://lifehacker.com/), [ProductHunt](https://www.producthunt.com/topics/mac) є чудовими ресурсами.

### Список заблокованих сайтів із піратським ПЗ

*Відмовтеся від піратства разом зі мною. Розробники програмного забезпечення мають свої права.*
...
* [Mac Power Users](https://www.relay.fm/mpu) - Дізнайтеся, як отримати максимум від ваших технологій Apple за допомогою тематичних випусків та гостей, що діляться своїм робочим процесом. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/podcast/mac-power-users/id458066753)

**[⬆ назад до початку](#contents)**

<!--end-->

## Учасники

Цей проєкт існує завдяки всім людям, які роблять свій внесок.
...
Ця робота ліцензована на умовах [Creative Commons Attribution 4.0 International License](http://creativecommons.org/licenses/by/4.0/).

[OSS Icon]: ico/min-oss.svg "Open Source Software"
[Freeware Icon]: ico/min-free.svg "Freeware"
[app-store Icon]: ico/min-app-store.svg "App Store Software"
[awesome-list Icon]: ico/min-awesome.svg "Awesome List"
[kfg.svg]: ico/kfg.svg
